...
public class MainServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/*
		 * //selectAll하는 기능 List<CommentDB> list = new ArrayList(); CommentDB comment =
		 * new CommentDB(); CommentService service = new CommentService(); list =
		 * service.selectAll();
		 * 
		...
		//comment.jsp로 보냄
		RequestDispatcher dis = request.getRequestDispatcher("commentMain.jsp");
